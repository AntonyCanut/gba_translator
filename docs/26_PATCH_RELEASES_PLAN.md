...
- [x] Ajouter les gardes rouges d'inspection BPS et de bundle canonique sans
  charger de ROM source.
- [x] Ajouter les gardes rouges de matérialisation locale et d'échec sur une
  mauvaise source.
- [x] Inverser les gardes des workflows : aucun secret/téléchargement/build
  ROM, publication depuis `patches/` et version issue du manifeste.
- [x] Implémenter la validation, la promotion locale et l'application du
  bundle BPS.
- [x] Faire dépendre pytest ROM et Playwright de la matérialisation locale des
  ROMs éphémères.
- [x] Versionner les quatre BPS reconstruits depuis le HEAD courant.
- [x] Documenter le fonctionnement contributeur et mainteneur dans le README.
- [x] Exécuter les suites ciblées, rapides, Vitest, ROM et Playwright
