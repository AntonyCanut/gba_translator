"""Regression guard for languages/de/patches/cry_label.py (B-188).

"Schrei" overflows the fixed 3-glyph "Cry" cell, so the patch relocates the
...
from languages.de.patches.cry_label import (
    CRY_PTR_OFFSETS,
    GBA_BASE,
    NAME,
    OLD_BODY_OFFSET,
...
class TestCryLabelDe(unittest.TestCase):
