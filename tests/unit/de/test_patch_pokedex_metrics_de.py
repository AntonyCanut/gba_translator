...
algorithm end-to-end under unicorn — no need to duplicate it here since the
bytes are the same). This file only covers what's DE-specific: the two-letter
field labels ("Gr"/"Ge" instead of "Ta"/"Po") and the German "kg" unit, plus
the generic apply/idempotency contract on a synthetic ROM.
"""
