...
normal pipeline at 0xA4C636 / 0xA4C64C are full phrases ("Il Pokémon
selvatico" / "Il Pokémon avversario") that read correctly without a suffix
cave. This just verifies the guard never mutates the ROM and correctly flags
an unterminated cell.
"""
