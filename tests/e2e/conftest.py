...
# Not git-tracked (generated by `make prepare-fr`): only exists in the main
# checkout, never copied into a worktree.
TRANSLATION_READY = MAIN_PROJECT_ROOT / "output" / "translation" / "2026-01-16_translation_ready.json"
