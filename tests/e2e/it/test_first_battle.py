...
The fixture is versioned together with a short declarative input route.  This
keeps the replay independent from the warehouse maze and fails explicitly if
...
def test_it_battle_menu_text_in_italian() -> None:
    ...
    The test shares the same versioned fixture and route as
    test_it_first_battle_reached_and_won.
    """
    if not IT_ROM.exists():
