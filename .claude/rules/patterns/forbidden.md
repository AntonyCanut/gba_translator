...
- ❌ Ajouter une ligne non vide à `languages/<lang>/combined_<lang>.txt` sans l'entrée
  exacte correspondante dans `languages/<lang>/protected_entries.yaml` dans le même commit.
