...
NAME_FIXES = {
    ...
    # Shadow Grunt trainers: "Grunt" is the individual trainer name stored
    # in the raw trainer-data table, read directly by the VS/battle-launch
    # screen. The translation pipeline never reaches these cells, so they ship
    # untranslated in English. "Sbire" is the French translation (henchman/grunt).
    # Same byte length as "Grunt" (6 glyphs), so stride is 8.
    # Issue #108: https://github.com/AntonyKervazoCanut/gba_translator/issues/108
    0x23ECFC: ("Grunt", "Sbire", 8),
    0x2421A4: ("Grunt", "Sbire", 8),
    0x24221C: ("Grunt", "Sbire", 8),
    0x242244: ("Grunt", "Sbire", 8),
    0x24226C: ("Grunt", "Sbire", 8),
    0x242294: ("Grunt", "Sbire", 8),
    0x2422BC: ("Grunt", "Sbire", 8),
    0x2422E4: ("Grunt", "Sbire", 8),
    0x24230C: ("Grunt", "Sbire", 8),
    0x242334: ("Grunt", "Sbire", 8),
    0x24235C: ("Grunt", "Sbire", 8),
    0x242384: ("Grunt", "Sbire", 8),
    0x2423AC: ("Grunt", "Sbire", 8),
    0x2423D4: ("Grunt", "Sbire", 8),
    0x2423FC: ("Grunt", "Sbire", 8),
    0x242424: ("Grunt", "Sbire", 8),
    0x24244C: ("Grunt", "Sbire", 8),
    0x242474: ("Grunt", "Sbire", 8),
    0x24249C: ("Grunt", "Sbire", 8),
    0x2424C4: ("Grunt", "Sbire", 8),
    0x2424EC: ("Grunt", "Sbire", 8),
    0x242514: ("Grunt", "Sbire", 8),
    0x24253C: ("Grunt", "Sbire", 8),
    0x24258C: ("Grunt", "Sbire", 8),
    0x2425DC: ("Grunt", "Sbire", 8),
    0x242604: ("Grunt", "Sbire", 8),
    0x24262C: ("Grunt", "Sbire", 8),
    0x242654: ("Grunt", "Sbire", 8),
    0x24267C: ("Grunt", "Sbire", 8),
    0x2426A4: ("Grunt", "Sbire", 8),
    0x2426F4: ("Grunt", "Sbire", 8),
    0x24271C: ("Grunt", "Sbire", 8),
    0x242744: ("Grunt", "Sbire", 8),
    0x24276C: ("Grunt", "Sbire", 8),
    0x242794: ("Grunt", "Sbire", 8),
    0x2427E4: ("Grunt", "Sbire", 8),
    0x244BAC: ("Grunt", "Sbire", 8),
    0x244BD4: ("Grunt", "Sbire", 8),
    0x244BFC: ("Grunt", "Sbire", 8),
    0x244C24: ("Grunt", "Sbire", 8),
    0x244C4C: ("Grunt", "Sbire", 8),
    0x244C74: ("Grunt", "Sbire", 8),
    0x244C9C: ("Grunt", "Sbire", 8),
    0x244CC4: ("Grunt", "Sbire", 8),
    0x24528C: ("Grunt", "Sbire", 8),
    0x2452DC: ("Grunt", "Sbire", 8),
}
